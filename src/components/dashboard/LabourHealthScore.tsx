...
const LabourHealthScore = () => {
  ...
  const { score, status, statusColor, ringColor, description } = useMemo(() => {
    ...
    let status: string, statusColor: string, ringColor: string, description: string;
    if (s >= 81) {
      status = "Strong";     statusColor = "text-green-400";   ringColor = "#22c55e";
      description = "Exceptionally low unemployment and strong workforce participation.";
    } else if (s >= 61) {
      status = "Healthy";    statusColor = "text-emerald-400"; ringColor = "#10b981";
      description = "Solid labour market with steady employment growth.";
    } else if (s >= 41) {
      status = "Recovering"; statusColor = "text-yellow-400";  ringColor = "#eab308";
      description = "Gradual improvements across key labour indicators.";
    } else {
      status = "Weak";       statusColor = "text-red-400";     ringColor = "#ef4444";
      description = "Labour market facing elevated unemployment or low participation.";
    }
      ...
      <div className="relative z-10 px-6 py-6">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-foreground">Labour Health Index</span>
          </div>
        ...
        <div className="flex justify-center">
          <div className="relative">
            <svg width="240" height="135" viewBox="0 0 240 135">
              <path
                d={`M 16 128 A ${R + 8} ${R + 8} 0 0 1 224 128`}
                fill="none"
              ...
              />
              <path
                d={`M 24 128 A ${R} ${R} 0 0 1 216 128`}
                fill="none"
