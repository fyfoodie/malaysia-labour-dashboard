    ...
    <div className="min-h-screen bg-background pb-24 md:pb-0">
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 space-y-6">
        ...
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, hsl(var(--primary)/0.12) 0%, hsl(var(--card)) 50%, hsl(var(--accent)/0.08) 100%)" }}
        >
          ...
          <div className="relative z-10 px-8 md:px-14 py-12 md:py-16 text-center">
            ...
            <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="flex justify-center">
              <StoryMode />
            </motion.div>

            <div className="flex justify-center gap-1.5 mt-8">
              {[...Array(5)].map((_, i) => (
                <motion.div key={i} className="w-1.5 h-1.5 rounded-full bg-primary/30"
